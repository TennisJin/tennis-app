  ...
  <view class="page-container">
      ...
      <view class="coach-basic">
        ...
        <view class="coach-info">
          ...
          <view class="coach-level">
            <text class="level-badge" :class="coach.level">{{ getLevelText(coach.level) }}</text>
          </view>
        </view>
      </view>
      
      <view class="coach-tags">
        <text class="tag" v-for="tag in coach.specialties" :key="tag">{{ tag }}</text>
      </view>
    ...
    <view class="coach-intro card">
      ...
      <view class="achievements" v-if="coach.achievements.length > 0">
        ...
        <view class="achievement-list">
          <text class="achievement-item" v-for="achievement in coach.achievements" :key="achievement">
            • {{ achievement }}
          </text>
        </view>
      </view>
        ...
        <view class="videos-list">
          ...
          >
            <view class="video-cover">
              <image class="cover-image" :src="video.cover" mode="aspectFill"></image>
    ...
    <view class="reviews-section card">
      ...
      <view class="review-summary">
        <view class="rating-overview">
          ...
          <view class="rating-stars">
            <text class="star" v-for="n in 5" :key="n" :class="{ filled: n <= Math.floor(coach.rating) }">★</text>
          </view>
      ...
      <view class="review-list">
        <view class="review-item" v-for="review in coach.reviews.slice(0, 3)" :key="review.id">
